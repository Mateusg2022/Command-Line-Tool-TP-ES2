...
@patch("src.minero.main.show_commits_info")
...
# -------------------- Testa comando loc --------------------
@patch("src.minero.main.check_function_exceed_limit_size")
...
@patch("src.minero.main.check_functions_exceed_param_limit")
...
@patch("src.minero.main.show_repository_generic_info")
